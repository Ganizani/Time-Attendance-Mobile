...
public class NotificationScheduler {
    ...
    public static void setReminder(Context context,Class<?> cls,int hour, int min,int resquestCode)
    {
        ...
        cancelReminder(context,cls,resquestCode);
    ...
    public static void showNotification(Context context,Class<?> cls,String title,String content,int resquestCode)
    {
        ...
        PendingIntent pendingIntent = stackBuilder.getPendingIntent(resquestCode, PendingIntent.FLAG_UPDATE_CURRENT);
       ...
       /* // Yes Action
        ...
        PendingIntent pendingIntentYes = PendingIntent.getBroadcast(context, DAILY_REMINDER_REQUEST_CODE, yesReceive, PendingIntent.FLAG_UPDATE_CURRENT);

        //No Action
        Intent noReceive = new Intent();
        noReceive.setAction("NO_ACTION");
        PendingIntent pendingIntentNo = PendingIntent.getBroadcast(context, DAILY_REMINDER_REQUEST_CODE, yesReceive, PendingIntent.FLAG_UPDATE_CURRENT);*/
